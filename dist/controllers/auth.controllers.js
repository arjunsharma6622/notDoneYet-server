...
exports.login = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res
        .status(200)
        .cookie("accessToken", accessToken, utils_1.cookieOptions)
        .cookie("refreshToken", refreshToken, utils_1.cookieOptions)
...
exports.refreshAccessToken = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return res
        .status(200)
        .cookie("accessToken", accessToken, utils_1.cookieOptions)
        .cookie("refreshToken", newRefreshToken, utils_1.cookieOptions)
